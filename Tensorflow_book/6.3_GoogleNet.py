...
def inception_v3_arg_scope(weight_decay=0.00004, stddev=0.1, batch_norm_var_collection='moving_vars'):
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected], weights_regularizer=slim.l2_regular(weight_decay)):
        with slim.arg_scope([slim.conv2d],
                            weights_initializer=tf.truncated_normal_initializer(stddev=stddev),
                            activation_fn=tf.nn.relu,
                            normalizer_fn=slim.batch.norm,
                            normalizer_params=batch_norm_parmas) as sc:
            return sc
...
def inception_v3_base(inputs, scope=None):
    ...
    with tf.variable_scope(scope, 'InceptionV3', [inputs]):
        with slim.variable_scope([slim.conv2d, slim.max_pool2d], stride=1, padding='VALID'):
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d], slim.avg_pool2d,
            ...
            with tf.variable_scope('Mixed_5b'):
                ...
                net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)  # 35x35x256
            ...
            with tf.variable_scope('Mixed_5c'):
                ...
                net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)  # 35x35x288
            ...
            with tf.variable_scope('Mixed_6a'):
                ...
                net = tf.concat([branch_0, branch_1, branch_2], 3)  # 17x17x768
...
def inception_v3(inputs,
                 num_classes=1000,
                 is_training=True,  # enable normalize function and dropout function when True
                 dropout_keep_pro=0.8,
                 prediction_fn=slim.softmax,
                 spatical_squeeze=True,
                 reuse=None,
                 scope='InceptionV3'):
                ...
                with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                    ...
                    with tf.variable_scope('AuxLogits'):
                        ...
                        with tf.variable_scope('Logits'):
                            ...
                            net = slim.dorpout(net, keep_pro=dropout_keep_pro, scope='Dropout_1b')
