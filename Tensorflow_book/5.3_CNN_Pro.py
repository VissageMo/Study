...
import sys
sys.path.append('/Users/mowenhao/PycharmProjects/models/tutorials/image/cifar10')
import cifar10
...
max_steps = 3000
batch_size = 128
data_dir = '/Users/mowenhao/PycharmProjects/Datasets/cifar'
...
# define the size of picture to cut, 24x24 with 3 color channel
...
norm1 = tf.nn.lrn(pool1, 4, bias=1.0, alpha=0.001/9.0, beta=0.75)  # use lrn function to increase generalization
...
# select Adam Optimizer, study rate = 1e-3
